...
@slyx.handle()
async def _():
    await slyx.finish(MessageSegment.text(
...
@mjzx.handle()
async def _():
    await mjzx.finish(MessageSegment.text(
...
@mzzz.handle()
async def _():
    await mzzz.finish(MessageSegment.text(
...
@mzyx.handle()
async def _():
    await mzyx.finish(MessageSegment.text(
...
@mzzy.handle()
async def _():
    await mzzy.finish(MessageSegment.text(
...
@syzx.handle()
async def _():
    await syzx.finish(MessageSegment.text(
...
@syzz.handle()
async def _():
    await syzz.finish(MessageSegment.text(
...
@syyx.handle()
async def _():
    await syyx.finish(MessageSegment.text(
