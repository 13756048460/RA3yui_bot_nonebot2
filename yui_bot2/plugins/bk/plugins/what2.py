...
@wqxt.handle()
async def _():
    await wqxt.finish(MessageSegment.image("file:///C:/Users/Administrator/Desktop/bk/wqxt.jpg"))

@hjxt.handle()
async def _():
    await hjxt.finish(MessageSegment.image("file:///C:/Users/Administrator/Desktop/bk/hjxt.jpg"))

@kjj.handle()
async def _():
    await kjj.finish(MessageSegment.image("file:///C:/Users/Administrator/Desktop/bk/kjj.jpg"))

@wxgs.handle()
async def _():
    await wxgs.finish(MessageSegment.image("file:///C:/Users/Administrator/Desktop/bk/jggs.jpg"))